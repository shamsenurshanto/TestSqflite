// class TheMealDBToModelConverter {
//  late List<Meals> meals;

//   TheMealDBToModelConverter({required this.meals});

//   TheMealDBToModelConverter.fromJson(Map<String, dynamic> json) {
//     if (json['meals'] != null) {
//       meals = <Meals>[];
//       for (var mealJson in json['meals']) {
//         meals.add(Meals.fromJson(mealJson));
//       }
//     }
//   }
...
//     if (meals != null) {
//       data['meals'] = meals.map((meal) => meal.toJson()).toList();
//     }
//     return data;
//   }
// }
