                  ...
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          "মেনু এড করুন ",
                          style: GoogleFonts.laila(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.black),
                        ),
                      ),
                    ),
                    Visibility(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            //,Milk tea loop 2
                            for (int i2 = 0;
                                i2 < demoController.itemUnderCategoryModelList.length && demoController.currentId.value == i;
                                i2++)
                              InkWell(
                                onTap: () {
                                  print("huuuuu");
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: GoogleFonts.roboto(
                                                      fontSize: 17, fontWeight: FontWeight.w500, color: Colors.pinkAccent),
                                                ),
                                              ),
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        InkWell(
                                                          onTap: () {
                                                            print("h");
                                                            demoController.deletePriceVariationNumber(i, j);
                                                          },
                                                          child: Icon(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        print("add dish");
                                        demoController.fetchDataUsingCategoryId(i); //visible item add
                                        demoController.setPriceVarriationTrueOrFalse(i);
                                      },
                                      child: Text(
                                        "ডিস এড করুন ",
